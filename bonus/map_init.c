...
static char	*tile_img_filenames[TILE_IMAGE_LENGTH] = {
	"xpm/tile_grass.xpm",
	"xpm/tile_wooden.xpm",
	"xpm/tile_door_close.xpm",
	"xpm/tile_door_open.xpm",
};
static char	*player_img__filenames[PLAYER_IMAGE_LENGTH] = {
...
static char	*collectable_img_filenames[COLLECTABLE_IMAGE_LENGTH] = {
	"xpm/chest_open_00.xpm",
	"xpm/chest_open_01.xpm",
	"xpm/chest_open_02.xpm",
	"xpm/chest_open_03.xpm",
};
static char	*enemy_img_filenames[ENEMY_IMAGE_LENGTH] = {
...
{
	_load_img(x, tile_img_filenames, x->tile_img, TILE_IMAGE_LENGTH);
	_load_img(x, player_img__filenames, x->player_img, PLAYER_IMAGE_LENGTH);
	_load_img(x, collectable_img_filenames, x->collectable_img, COLLECTABLE_IMAGE_LENGTH);
	_load_img(x, enemy_img_filenames, x->enemy_img, ENEMY_IMAGE_LENGTH);
}